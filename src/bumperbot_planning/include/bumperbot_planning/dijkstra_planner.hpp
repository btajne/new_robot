...
struct GraphNode
{
    ...
    GraphNode(int in_x, int in_y)
      : x(in_x), y(in_y), cost(0), prev(nullptr) {}
    ...
    GraphNode operator+(std::pair<int,int> const & other){ return GraphNode(x+other.first, y+other.second); }
};
